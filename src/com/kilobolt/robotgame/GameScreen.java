...
import com.kilobolt.robotgame.Gyroscope;
...
public class GameScreen extends Screen {
	...
	public GameScreen(Game game) {
		...
		System.out.println(Gyroscope.zRotation);
	...
	public void update(float deltaTime) {
		...
		if (state == GameState.Running){
			final float rotation = Gyroscope.zRotation;
			updateRunning(touchEvents, deltaTime, rotation);
		}
	...
	private void updateRunning(List<TouchEvent> touchEvents, float deltaTime, float rotation) {

		//gyroscope control
		robot.setAccX(-Math.sin(PI * (double)rotation) /10);
		//robot.setAccY(Math.cos(PI * (double)rotation) /10);
		robot.setAccY(Gyroscope.xRotation);
